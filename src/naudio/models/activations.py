...
class LeakyReLU(nnx.Module):
    # @jaxtyped(typechecker=beartype)
    def __init__(self, alpha: float=0.005, negative_slope: float|None=None, **kwargs) -> None:
        self.alpha = alpha
...
def get_activation(activation: Literal["elu", "snake", "relu", "leaky_relu"]|str, channels: int|None = None, **kwargs) -> Any:
