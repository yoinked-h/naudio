...
class AudioOobleckVAE(nn.Module):
    def __init__(self,
                 ...
                 final_tanh=False):
        super().__init__()
        self.encoder = OobleckEncoder(in_channels, channels, latent_dim * 2, c_mults, strides, use_snake)
        self.decoder = OobleckDecoder(in_channels, channels, latent_dim, c_mults, strides, use_snake, use_nearest_upsample=use_nearest_upsample, final_tanh=final_tanh)
